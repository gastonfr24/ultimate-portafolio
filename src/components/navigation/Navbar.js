...
function Navbar() {
  ...
  Poryectos IA
  <div className="absolute -top-3.5 group-hover:opacity-0 transition duration-500"><span className="bg-violet-cus text-white px-1 -py-1 rounded-lg text-[8px] font-bold opacity-80">Nuevo</span></div>
</NavLink>
